...
/**
 * Request personalizado para la validación de departamentos.
 *
 * Este FormRequest se utiliza para validar las solicitudes entrantes para la creación y actualización de departamentos,
