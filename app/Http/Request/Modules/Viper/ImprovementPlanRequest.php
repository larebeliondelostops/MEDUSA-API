...
/**
 * Request personalizado para la validación de datos de plan de mejora.
 *
 * Este FormRequest se utiliza para validar las solicitudes entrantes para la creación y actualización de planes de mejora,
 ...
 * @version    v1.0.0
 */
class ImprovementPlanRequest extends FormRequest
{
    /**
