...
/**
 * Request personalizado para la validación de datos de Clases de Hitos.
 *
 * Este FormRequest se utiliza para validar las solicitudes entrantes para la creación y actualización de Clases de Hitos,
 ...
 * @version    v1.0.0
 */
class MilestoneClassRequest extends FormRequest
{
    /**
