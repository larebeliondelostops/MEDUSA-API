...
/**
 * Request personalizado para la validación de datos de Indicadores.
 *
 * Este FormRequest se utiliza para validar las solicitudes entrantes para la creación y actualización de Indicadores,
