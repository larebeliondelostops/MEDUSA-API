  ...
  public function run()
  {
    ...
    foreach ($dataArray['array'] as $Data) {
      ...
      DB::table('health')->insert([
        ...
        'emergency_patients' => $Data['properties']['emergencyPatients'],
        'emergency_beds_available' => $Data['properties']['emergencyBedsAvailable'],
        'available_operating_rooms' => $Data['properties']['availableOperatingRooms'],
        'intensive_care_unit_available' => $Data['properties']['intensiveCareUnitAvailable'],
        'first_level_beds' => $Data['properties']['firstLevelBeds'],
        'second_level_beds' => $Data['properties']['secondLevelBeds'],
        'third_level_beds' => $Data['properties']['thirdLevelBeds'],
        'blood_bank' => $Data['properties']['bloodBank'],
        'doctors_in_the_shift' => $Data['properties']['doctorsInTheShift'],
        'nurses_in_the_shift' => $Data['properties']['nursesInTheShift'],
        'affiliated_ips' => $Data['properties']['affiliatedIps'],
        'number_of_emergencies_day' => $Data['properties']['numberOfEmergenciesDay'],
        'created_at' => now(),
        'updated_at' => now(),
      ]);
    }
