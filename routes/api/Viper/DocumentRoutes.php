...
Route::prefix('/viper/document')->group(function () {
    ...
    Route::get('list-deleted/folder/{folderId}', [DocumentController::class, 'getDeletedDocumentsByFolder']);
    Route::get('list-deleted/project/{projectId}', [DocumentController::class, 'getDeletedDocumentsByProject']);
    ...
    Route::delete('delete-permanent/several', [DocumentController::class, 'destroyForceSeveral']);
