...
Route::middleware(['jwt.verify'/* , 'role:Administrador' */])->group(function() {
    ...
    Route::get('alarms/getOne/{id}', [AlarmsController::class, 'getOne']); // editar un campo en la tabla entidades
    Route::get('alarms/allTable', [AlarmsController::class, 'allTable']); // editar un campo en la tabla entidades
