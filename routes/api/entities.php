...
Route::middleware(['jwt.verify'/* , 'role:Administrador' */])->group(function() {
    ...
    Route::get('entities/getOne/{id}', [entitiesController::class, 'getOne']); // editar un campo en la tabla entidades
    Route::get('entities/allTable', [entitiesController::class, 'allTable']); // editar un campo en la tabla entidades
